...
outputFunctions
    ...
    : 
     ...
     ^(ECHO expression+)
      {currentScope.getScopeSymbol().setName("echo");}
    ...
    |
     ...
     ^(PRINT expression+)
      {currentScope.getScopeSymbol().setName("print");}
    ...
    |
	 {
      ...
      ^(PRINTF expression+)
       {currentScope.getScopeSymbol().setName("printf");}
    ...
    |
     ...
     ^(DIE expression+)
      {currentScope.getScopeSymbol().setName("die");}
    ...
    |
	{
     ...
     ^(ERROR expression+)
      {currentScope.getScopeSymbol().setName("error");} 	
    ;
